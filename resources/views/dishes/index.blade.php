                ...
                <div class="col-3 mt-3">
                    ...
                    <div class="row">
                        <div class="col-xs-18 col-sm-6 col-md-3">
                            <div class="thumbnail">
                                <img src="{{ asset('storage/files/'.$dish->image) }}" width="320" height="300">
                                <div class="caption">
                                    <h4>{{ $dish->name }}</h4>
                                    {{--                                        <p>{{ $dish->description }}</p>--}}
                                    <p><strong>Стоимость </strong> {{ $dish->cost }} сом</p>

                                </div>
                            </div>
                        </div>
                        <button class="btn btn-warning cart" data-id="{!! $dish->id !!}" data-sum="{{ $dish->cost }}" >Add to cart</button>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button class="btn btn-success" data-id="{!! $dish->id !!}">add to cart </button>
                                </div>
                            </div>
                        </div>
                    </div>
